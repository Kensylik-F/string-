...
START_TEST(s21_strncpy_test) {
  ...
  char str1[] = "Hello, World!";
  ck_assert_str_eq(s21_strncpy(data_str, str1, 20),
                   strncpy(data_str_copy, str1, 30));
  ck_assert_str_eq(s21_strncpy(data_str, str1, 5),
                   strncpy(data_str_copy, str1, 5));
  ck_assert_str_eq(s21_strncpy(data_str, str1, 0),
                   strncpy(data_str_copy, str1, 0));

  char str2[] = "";
  ck_assert_str_eq(s21_strncpy(data_str, str2, 1),
                   strncpy(data_str_copy, str2, 1));
  ck_assert_str_eq(s21_strncpy(data_str, str2, 10),
...
START_TEST(s21_insert_test) {
  ...
  char *s21_insert_3 = s21_insert(str3, str3_copy, 10);
...
START_TEST(s21_sprintf_c_test) {
  ...
  int orig_c_sprintf_7 = sprintf(data_copy, "%c", "Hello, World!");
...
START_TEST(s21_sprintf_d_test) {
  ...
  int orig_d_sprintf_7 = sprintf(data_copy, "%ld", str2);
  ...
  int s21_d_sprintf_9 = s21_sprintf(data, "%ld", str3);
  int orig_d_sprintf_9 = sprintf(data_copy, "%ld", str3);
  ...
  int s21_d_sprintf_12 = s21_sprintf(data, "%d %d %d", 1, 2, 3, 4);
  int orig_d_sprintf_12 = sprintf(data_copy, "%d %d %d", 1, 2, 3, 4);
  ck_assert_int_eq(s21_d_sprintf_11, orig_d_sprintf_11);
}
END_TEST
...
START_TEST(s21_sprintf_u_test) {
  ...
  int s21_u_sprintf_4 = s21_sprintf(data, "%lu", str3);
  int orig_u_sprintf_4 = sprintf(data_copy, "%lu", str3);
  ck_assert_int_eq(s21_u_sprintf_4, orig_u_sprintf_4);

  int s21_u_sprintf_5 = s21_sprintf(data, "%lu", str2);
  int orig_u_sprintf_5 = sprintf(data_copy, "%lu", str2);
...
START_TEST(s21_sprintf_f_test) {
  ...
  int s21_f_sprintf_5 = s21_sprintf(data, "%%", str4);
  int orig_f_sprintf_5 = sprintf(data_copy, "%%", str4);
  ck_assert_int_eq(s21_f_sprintf_5, orig_f_sprintf_5);
  ...
  int s21_f_sprintf_7 = s21_sprintf(data, "%hg", str1);
  int orig_f_sprintf_7 = sprintf(data_copy, "%hg", str1);
  ck_assert_int_eq(s21_f_sprintf_6, orig_f_sprintf_6);

  int s21_f_sprintf_8 = s21_sprintf(data, "hg", str1);
  int orig_f_sprintf_8 = sprintf(data_copy, "hg", str1);
  ck_assert_int_eq(s21_f_sprintf_8, orig_f_sprintf_8);
  ...
  int s21_f_sprintf_10 = s21_sprintf(data, "%f", '123');
  int orig_f_sprintf_10 = sprintf(data_copy, "%f", '123');
